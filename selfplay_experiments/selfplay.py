...
lc0_path_white = config['lc0_path_white']
lc0_path_black = config['lc0_path_black']
...
# Initialize engines
engine1 = chess.engine.SimpleEngine.popen_uci(lc0_path_white)
engine2 = chess.engine.SimpleEngine.popen_uci(lc0_path_black)
...
try:
    for game_number in range(start_game, num_games + 1):
        ...
        print("game number is: " + str(game_number))
        ...
        # Set game headers
        game.headers["Event"] = "Leela Thompson Training"
        ...
        try:
            while not board.is_game_over():
                ...
                print("turn_number is: " + str(turn_number))
